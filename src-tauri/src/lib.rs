...
pub fn run() {
    ...
    let mut builder = tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::runbooks::list_remediation_runbooks,
            commands::runbooks::create_remediation_runbook,
            commands::runbooks::update_remediation_runbook,
            commands::runbooks::delete_remediation_runbook,
            ...
            commands::dbhub::test_db_connection_draft,
