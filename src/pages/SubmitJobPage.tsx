...
import type { SubmitJobFormValues } from "@/types/domain";
          ...
          <Card>
            ...
            <CardContent className="flex flex-col gap-3">
              <div className="grid grid-cols-[1fr_1fr_auto] gap-3">
                <Input value="spark.sql.shuffle.partitions" readOnly />
                <Input
                  value={form.watch("sparkConfig")["spark.sql.shuffle.partitions"] ?? ""}
                  onChange={(event) =>
                    form.setValue("sparkConfig", {
                      ...form.getValues("sparkConfig"),
                      "spark.sql.shuffle.partitions": event.target.value
                    })
                  }
                  placeholder="200"
                />
                <Button type="button" variant="ghost" size="icon" aria-label="Remove Spark config row">
